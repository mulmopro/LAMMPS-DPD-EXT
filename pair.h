...
class Pair : protected Pointers {
 ...
 public:
  ...
  void ev_tally_SH(int, int, int, int, double, double, double, double, double, double, double, double);
 ...
 protected:
  ...
  void ev_tally_xyz(int, int, int, int, double, double, double, double, double, double, double,
                    double);
  void ev_tally_xyz_SH(int, int, int, int, double, double, double, double, double, double, double, double, double, double, double, double, double,
                    double);                 
