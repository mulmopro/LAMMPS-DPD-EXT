...
void Pair::ev_tally_SH(int i, int j, int nlocal, int newton_pair,
                    double evdwl, double ecoul, double fpair, double fpairD, double fpairR,
                    double delx, double dely, double delz)
{
  double evdwlhalf,ecoulhalf,epairhalf,v[6];
  ...
  if (vflag_either) {
    v[0] = delx*delx*fpair;
    v[0] += delx*delx*fpairD;
    v[0] += delx*delx*fpairR;
    v[1] = dely*dely*fpair;
    v[1] += dely*dely*fpairD;
    v[1] += dely*dely*fpairR;
    v[2] = delz*delz*fpair;
    v[2] += delz*delz*fpairD;
    v[2] += delz*delz*fpairR;      
    v[3] = delx*dely*fpair;
    v[3] += delx*dely*fpairD;
    v[3] += delx*dely*fpairR;
    v[4] = delx*delz*fpair;
    v[4] += delx*delz*fpairD;
    v[4] += delx*delz*fpairR;
    v[5] = dely*delz*fpair;
    v[5] += dely*delz*fpairD;
    v[5] += dely*delz*fpairR;
...
void Pair::ev_tally_xyz_SH(int i, int j, int nlocal, int newton_pair,
                        double evdwl, double ecoul,
                        double fx, double fy, double fz,
